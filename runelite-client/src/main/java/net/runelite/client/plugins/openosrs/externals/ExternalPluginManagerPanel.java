	...
	private JPanel titleBar()
	{
		...
		addGHRepo.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(MouseEvent mouseEvent)
			{
				...
				int option =
					JOptionPane.showConfirmDialog(frame, message, "Add repository", JOptionPane.OK_CANCEL_OPTION);
				...
				{
					JOptionPane.showMessageDialog(frame, "This repository already exists.", "Error!",
				...
				{
					JOptionPane.showMessageDialog(frame, "This doesn't appear to be a valid repository.", "Error!",
						JOptionPane.ERROR_MESSAGE);
					return;
				}
