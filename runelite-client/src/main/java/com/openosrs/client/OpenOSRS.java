...
public class OpenOSRS
{
	...
	public static final File EXTERNALPLUGIN_DIR = new File(OPENOSRS_DIR, "external-plugins");
	...
	static
	{
		try
		{
			properties.load(RuneLite.class.getResourceAsStream("runelite.properties"));
		}
		catch (IOException e)
		{
			e.printStackTrace();
		...
		SYSTEM_VERSION = properties.getProperty("runelite.version", "0.0.0");
